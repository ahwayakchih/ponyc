...
# Reads optional SMP and RAM from environment; defaults to '2' and '8G'.
set -euo pipefail
...
HAIKU_PACKAGES="cmake python3.14 libexecinfo_devel openssl3_devel llvm22 llvm22_clang llvm22_libs llvm22_lld llvm22_openmp rsync"
